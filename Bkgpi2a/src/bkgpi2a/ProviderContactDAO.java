...
/**
 * Classe qui implémente le pattern DAO pour la classe ProviderContact
...
public class ProviderContactDAO extends MongoPatternDAO {
    ...
    /**
     * Ajoute un intervenant à la collection 
     * @param providerContact intervenant à ajouter à la collection
     */
