...
@JsonTypeName("InterventionReportGottenFromProvider")
public class InterventionReportGottenFromProvider extends Event {
...
//    private Persona recipient;
    ...
    /**
     * Constructeur de la classe InterventionReportGottenFromProvider
     */
    public InterventionReportGottenFromProvider() {
        setEventTypeUid(INTERVENTION_REPORT_GOTTEN_FROM_PROVIDER.getUid());
        setEventType(INTERVENTION_REPORT_GOTTEN_FROM_PROVIDER.getName());
    }
