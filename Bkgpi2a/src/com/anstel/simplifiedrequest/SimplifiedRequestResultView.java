 ...
 * @version 1.42.3
 * @see <A href="https://declarimmo-org.github.io/API/#simplifiedrequestresultview">SimplifiedRequestResultView</A>
 */
@JsonPropertyOrder({"_links", "result"})
@JsonIgnoreProperties(value = {"aggregations"}, ignoreUnknown = true)
