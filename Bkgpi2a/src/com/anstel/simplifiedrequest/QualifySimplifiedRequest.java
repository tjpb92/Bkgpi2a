 ...
 * @version 1.42.3
 * @see <A href="https://declarimmo-org.github.io/API/#qualify-a-simplifiedrequest">QualifySimplifiedRequest</A>
 */
@JsonIgnoreProperties(value = {"_id", "date", "sentDate", "commandTypeUid", "status", "nbError"}, ignoreUnknown = true)
